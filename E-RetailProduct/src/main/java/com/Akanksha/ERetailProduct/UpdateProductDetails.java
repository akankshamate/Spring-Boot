...
public class UpdateProductDetails {
	...
	@Column(name="price")
	@NotNull(message="Price value should not be null Please enter valid price")
	 ...
	 * @param price
	 */
	public UpdateProductDetails(int productID, String productName, int categoryID, double price) {
		super();
